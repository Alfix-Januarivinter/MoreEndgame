...
public class ReaperToolMaterial {
    public static final TagKey<Item> REPAIRS_REAPER_ARMOR = TagKey.create(BuiltInRegistries.ITEM.key(), ResourceLocation.fromNamespaceAndPath(MoreEndgame.MOD_ID, "repairs_reaper_armor"));

    public static final TagKey<Block> INCORRECT_FOR_REAPER_TOOL = TagKey.create(BuiltInRegistries.BLOCK.key(),
            ResourceLocation.fromNamespaceAndPath(MoreEndgame.MOD_ID, "incorrect_for_reaper_tool"));
