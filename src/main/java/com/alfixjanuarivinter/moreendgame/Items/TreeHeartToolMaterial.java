...
public class TreeHeartToolMaterial {
    public static final TagKey<Item> REPAIRS_TREE_HEART_ARMOR = TagKey.create(BuiltInRegistries.ITEM.key(), ResourceLocation.fromNamespaceAndPath(MoreEndgame.MOD_ID, "repairs_tree_heart_armor"));

    public static final TagKey<Block> INCORRECT_FOR_TREE_HEART_TOOL = TagKey.create(BuiltInRegistries.BLOCK.key(),
            ResourceLocation.fromNamespaceAndPath(MoreEndgame.MOD_ID, "incorrect_for_tree_heart_tool"));
