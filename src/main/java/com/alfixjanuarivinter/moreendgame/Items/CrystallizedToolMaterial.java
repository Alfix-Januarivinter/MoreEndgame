...
public class CrystallizedToolMaterial {
    public static final TagKey<Item> REPAIRS_CRYSTALLIZED_ARMOR = TagKey.create(BuiltInRegistries.ITEM.key(), ResourceLocation.fromNamespaceAndPath(MoreEndgame.MOD_ID, "repairs_crystallized_armor"));

    public static final TagKey<Block> INCORRECT_FOR_CRYSTALLIZED_TOOL = TagKey.create(BuiltInRegistries.BLOCK.key(),
            ResourceLocation.fromNamespaceAndPath(MoreEndgame.MOD_ID, "incorrect_for_crystallized_tool"));
